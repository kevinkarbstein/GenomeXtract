...
"""
This script searches the public NCBI database for the closest available plastiid, mitochondrial or nuclear genome sequence(s) from a given species or taxonomic rank. 
